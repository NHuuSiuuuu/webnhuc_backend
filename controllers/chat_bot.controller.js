...
exports.chatBot = async (req, res) => {
  try {
    ...
    const products = await ProductModel.find().select("slug title price sizes").lean();
    ...
    contents.unshift({
      ...
      parts: [
        {
          text: `Bạn là chatbot hỗ trợ khách hàng của NHuu – cửa hàng thời trang trực tuyến.  
